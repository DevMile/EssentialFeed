...
class RemoteFeedLoaderTests: XCTestCase {
    ...
    func test_load_deliversFeedItemsOn200HTTPResponseWithValidJSON() {
        ...
        let item1 = FeedItem(id: UUID(), description: nil, location: nil, imageURL: URL(string: "https://a-image-url.com")!)
        let item1JSON = [
            "id": item1.id.uuidString,
            "image": item1.imageURL.absoluteString
        ]
        
        let item2 = FeedItem(id: UUID(), description: "a description", location: "a location", imageURL: URL(string: "https://another-image-url.com")!)
        let item2JSON = [
